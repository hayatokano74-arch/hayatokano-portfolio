 ...
 * News CRUD API
 *
 * GET    /api/news.php          → 全件 JSON
 * GET    /api/news.php?slug=xxx → 1件 JSON
 * POST   /api/news.php          → 新規作成/更新（JSON body）
 * DELETE /api/news.php?slug=xxx → 削除
 */
...
function handle_get(): never {
    ...
    // 全件取得
    $rows = db_all('news', 'date DESC, id DESC');
