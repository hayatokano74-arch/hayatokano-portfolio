...
export const about = {
  ...
  cv: [
    { year: "2025", content: "個展「Field Notes」GALLERY SPACE" },
    { year: "2025", content: "グループ展「見ることの輪郭」東京都写真美術館" },
    { year: "2025", content: "アーティスト・トーク「撮影と歩行」TALK SPACE" },
    { year: "2024", content: "写真集「距離について」自主出版" },
    { year: "2024", content: "アーティスト・イン・レジデンス（石巻市）" },
    { year: "2024", content: "グループ展「Ground Level」MOCA Taipei" },
    { year: "2023", content: "個展「観察ノート」SPACE A" },
    { year: "2023", content: "グループ展「Landscape and Memory」Seoul Art Center" },
    { year: "2023", content: "写真賞ファイナリスト　第15回写真新世紀" },
    { year: "2022", content: "個展「Field / Frame」Gallery B" },
    { year: "2022", content: "レジデンスプログラム参加（フィンランド）" },
    { year: "2021", content: "グループ展「新しい風景」京都芸術センター" },
    { year: "2021", content: "映像作品「歩行の記録」上映（恵比寿映像祭）" },
    { year: "2020", content: "写真集「手前の光」刊行" },
    { year: "2020", content: "個展「手前の光」Gallery C" },
    { year: "2019", content: "グループ展「写真の現在」東京都現代美術館" },
    { year: "2018", content: "東京藝術大学大学院美術研究科修了" },
    { year: "2018", content: "修了制作展 優秀賞" },
    { year: "2016", content: "東京藝術大学美術学部卒業" },
  ],
};
