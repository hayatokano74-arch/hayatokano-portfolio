...
export const NAV_ITEMS: { num: string; label: string; href: string; section: Section }[] = [
  ...
  { num: "05", label: "Garden", href: "/garden", section: "Garden" },
  { num: "06", label: "News", href: "/news", section: "News" },
  { num: "07", label: "About", href: "/about", section: "About" },
  { num: "08", label: "Contact", href: "/contact", section: "Contact" },
];
